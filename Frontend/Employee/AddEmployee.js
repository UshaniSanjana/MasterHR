...
export default function AddEmployee({ route }) {
  ...
  const handleRegister = () => {
    if (
      ...
      WorkingDays.trim() === "" ||
      AllowedLeave.trim() === "" ||
      PaymentData.Basicsalary.trim() === "" ||
      PaymentData.Costofliving.trim() === "" ||
      PaymentData.Foodallowance.trim() === "" ||
      PaymentData.Medicalallowance.trim() === "" ||
    ...
    axios
      .post(`${process.env.API_URL}/Employee`, employeeData)
      .then((response) => {
        ...
        axios
          .post(`${process.env.API_URL}/Attendance`, attendanceData)
          .then((response) => {
            console.log(response.data);
            SetWorkingDays("");
            SetAllowedLeave("");
        ...
        axios
          .post(`${process.env.API_URL}/Payment`, paymentData)
          .then((response) => {
            console.log(response.data);
        ...
        >
          ...
          <View style={{ marginTop: 30 }}>
            <View style={{}}>
              ...
              ></TextInput>
              <Text style={{ fontSize: 15, fontWeight: 600 }}>Job Role:</Text>
              <TextInput
                value={JobRole}
              ...
              <Text style={{ fontSize: 15, fontWeight: 600 }}>Mobile:</Text>
              <TextInput
                value={mobile}
            ...
            >
              ...
              <TextInput
                value={AllowedLeave}
                onChangeText={(text) => SetAllowedLeave(text)}
                style={{ borderBottomWidth: 1 }}
              ></TextInput>
            </View>
            ...
            >
              ...
              >
                <Text
                  style={{ fontSize: 20, fontWeight: 600, color: "#2E4D6C" }}
                >
                  Allowance
                </Text>
                ...
                <TextInput
                  value={PaymentData.Costofliving}
                  onChangeText={(text) =>
                    handleInputChange("Costofliving", text)
                  }
                  style={{ borderBottomWidth: 1 }}
                ></TextInput>
                <Text style={{ fontSize: 15, fontWeight: 600 }}>
                ...
                <TextInput
                  value={PaymentData.Foodallowance}
                  onChangeText={(text) =>
                    handleInputChange("Foodallowance", text)
                  }
                  style={{ borderBottomWidth: 1 }}
                ></TextInput>
                <Text style={{ fontSize: 15, fontWeight: 600 }}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    handleInputChange("Medicalallowance", text)
                  }
                  style={{ borderBottomWidth: 1 }}
                ></TextInput>
                <Text style={{ fontSize: 15, fontWeight: 600 }}>
                ...
                <TextInput
                  value={PaymentData.Otherallowance}
                  onChangeText={(text) =>
                    handleInputChange("Otherallowance", text)
                  }
                  style={{ borderBottomWidth: 1 }}
                ></TextInput>
              </View>
